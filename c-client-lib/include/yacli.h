...
/* YAC_ATTR_SERVER_STATUS */
#define YAC_SERVER_NOT_CONNECTED        0x0
#define YAC_SERVER_NORMAL               0x1
...
typedef enum EnYacEnvAttr {
    ...
    YAC_ATTR_NCHAR_LITERAL_REPLACE = 67,
} YacEnvAttr;
...
/* YACLI ping APIs */
#define YAC_DEFAULT_PING_TIMEOUT (YacUint32)(-1)
YacResult yacPingWithTimeout(YacHandle hConn, YacUint32 timeout /*ms*/);
...
YacResult yacLobCreateTemporary(YacHandle hConn, YacLobLocator* loc);
YacResult yacLobRead(YacHandle hConn, YacLobLocator* loc, YacUint64* bytes, YacUint8* buf, YacUint64 bufLen);
YacResult yacLobReadWithCharset(YacHandle hConn, YacLobLocator* loc, YacUint64* bytes, YacUint8* buf, YacUint64 bufLen, YacCharsetCode charset);
YacResult yacLobWrite(YacHandle hConn, YacLobLocator* loc, YacUint64* bytes, YacUint8* buf, YacUint64 bufLen);
YacResult yacLobWriteWithCharset(YacHandle hConn, YacLobLocator* loc, YacUint64* bytes, YacUint8* buf, YacUint64 bufLen, YacCharsetCode charset);
...
YacResult yacLobWriteAppendWithCharset(YacHandle hConn, YacLobLocator* loc, YacUint64* byteSize, YacUint64* charSize, YacUint8* buf, YacUint64 bufLen, YacCharsetCode charset);
...
YacResult yacLobWrite2WithCharset(YacHandle hConn, YacLobLocator* loc, YacUint64* byteSize, YacUint64* charSize, YacUint64 offset, YacUint8* buf, YacUint64 bufLen, YacCharsetCode charset);
...
YacResult yacLobRead2WithCharset(YacHandle hConn, YacLobLocator* loc, YacUint64* byteSize, YacUint64* charSize, YacUint64 offset, YacUint8* buf, YacUint64 bufLen, YacCharsetCode charset);
